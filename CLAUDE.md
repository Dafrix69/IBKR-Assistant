...
analysis      backtest priceaction screener research ideaRetrieval optionwall anomaly flyexit tradereview tradeOutcomes fillsCsv optionTradesCsv optionPositionsCsv tradeSimilar ibtrades macro market alerts
domain        config.ts  models.ts  store.ts  importedTrades.ts  positions.ts  marketdata.ts
