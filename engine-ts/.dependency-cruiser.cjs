...
const L = {
  ...
  analysis:    "^src/(backtest|priceaction|screener|research|ideaRetrieval|optionwall|anomaly|flyexit|tradereview|tradeOutcomes|fillsCsv|ibtrades|macro|market|alerts)\\.ts$",
