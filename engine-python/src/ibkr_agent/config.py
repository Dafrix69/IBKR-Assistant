...
PROJECT_ROOT = PACKAGE_ROOT.parent.parent  # engine-python/
# config/ 与 prompts/ 是两个引擎共用的资产,放在仓库根(engine-python 的上一级)
REPO_ROOT = PROJECT_ROOT.parent
DEFAULT_PROMPT_DIR = REPO_ROOT / "prompts"
DEFAULT_CONFIG_PATH = Path(
    os.environ.get("DAFRI_CONFIG", REPO_ROOT / "config" / "settings.json")
)
