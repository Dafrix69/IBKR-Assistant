...
#   DAFRI_PROMPT_DIR="<App>/Contents/Resources/engine/prompts" node tools/smoke_engine_ts.js "<App>/Contents/Resources/engine-ts" --runner "<App>/Contents/MacOS/IBKR-Assistant"
```
